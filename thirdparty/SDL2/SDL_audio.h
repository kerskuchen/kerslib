 ...
 */
/* @{ */
#define AUDIO_floatLSB 0x8120 /**< 32-bit floating point samples */
#define AUDIO_floatMSB 0x9120 /**< As above, but big-endian byte order */
#define AUDIO_float AUDIO_floatLSB
/* @} */
...
#define AUDIO_floatSYS AUDIO_floatLSB
#else
#define AUDIO_U16SYS AUDIO_U16MSB
#define AUDIO_S16SYS AUDIO_S16MSB
#define AUDIO_S32SYS AUDIO_S32MSB
#define AUDIO_floatSYS AUDIO_floatMSB
#endif
/* @} */
...
typedef struct SDL_AudioCVT {
  ...
  SDL_AudioFilter
      filters[SDL_AUDIOCVT_MAX_FILTERS + 1]; /**< NULL-terminated list of filter functions */
 ...
 */
extern DECLSPEC SDL_AudioDeviceID SDLCALL SDL_OpenAudioDevice(const char* device,
                                                              int iscapture,
...
extern DECLSPEC SDL_AudioSpec* SDLCALL SDL_LoadWAV_RW(
    SDL_RWops* src, int freesrc, SDL_AudioSpec* spec, Uint8** audio_buf, Uint32* audio_len);
